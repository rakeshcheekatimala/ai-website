  ...
  describe('mockProjects', () => {
    ...
    it('each project has required fields', () => {
      mockProjects.forEach((project: Project) => {
        ...
        expect(project).toHaveProperty('constraints')
        expect(project).toHaveProperty('impact')
        expect(project).toHaveProperty('roleDetails')
        expect(typeof project.title).toBe('string')
        expect(typeof project.slug).toBe('string')
        expect(typeof project.summary).toBe('string')
        expect(typeof project.problem).toBe('string')
        expect(typeof project.constraints).toBe('string')
        expect(typeof project.impact).toBe('string')
        expect(typeof project.roleDetails).toBe('string')
        expect(Array.isArray(project.approach)).toBe(true)
      })
    })
  })
